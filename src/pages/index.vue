  ...
  <div>
    ...
    <main>
        ...
        <div class="container mx-auto pb-24 pt-24 px-4 relative">
          <div class="-mx-4 flex flex-wrap items-center space-y-6 lg:space-y-0">
            <div class="px-4 w-full lg:w-6/12">
              ...
              <a
                href="#"
                class="border border-white font-normal hover:bg-white hover:text-secondary-500 inline-block px-6 py-2 text-white"
                >Buy Now</a
              >
            </div>
            <div class="px-4 w-full lg:w-6/12">
      ...
      <section class="py-24">
        <div class="container mx-auto px-4 relative">
          <div class="-mx-4 flex flex-wrap items-center">
            ...
            <div class="px-4 py-6 w-full lg:mx-auto lg:pt-12 lg:w-5/12">
              <h2
                class="font-medium leading-tight mb-1 text-gray-500 uppercase"
              >
                Custom Design
      ...
      <section class="bg-secondary-100 py-12 text-gray-800">
        <div class="container mx-auto px-4 relative">
          ...
          <SubscribeToDeals client:visible />
          <BookAnAppointment client:visible />
        </div>
      </section>
    </main>
    <footer
    ...
    >
      <div class="container mx-auto px-4 py-6 relative">
        ...
        <div class="flex-wrap inline-flex mb-6 space-x-4">
          <a
            href="#"
            aria-label="facebook"
      ...
      <div class="container mx-auto px-4 relative md:text-left">
        <div class="py-4 text-sm">
          <div
            class="flex flex-wrap -mx-4 items-center"
